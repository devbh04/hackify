...
const AppBar = () => {
  ...
  return (
    <>
      <div className="px-4 lg:px-8 py-4 bg-[#f8faf9]/80 backdrop-blur-xl shadow-[0_8px_32px_rgba(25,28,28,0.06)] flex justify-between items-center sticky top-0 z-30 transition-all">
        {/* Left section: Logo + Search bar */}
        <div className="flex items-center flex-grow space-x-4 lg:space-x-8">
          {/* Mobile menu button */}
          <button
            className="lg:hidden"
            onClick={() => {
          ...
          >
            <Menu className="h-6 w-6 text-[#1c1b1b]" />
          </button>

          {/* Logo */}
          <Link href="/" className="flex items-center flex-shrink-0">
            <div className="text-2xl font-extrabold tracking-tighter text-[#1c1b1b]">Hackify</div>
          </Link>

          {/* Search bar (visible only on lg+) */}
          <div
            className={`hidden lg:flex relative items-center bg-surface-container-highest rounded-full px-4 transition-all duration-300 ${getSearchBarWidth()}`}
          >
        ...
        <div className="flex items-center justify-end space-x-4 lg:space-x-8">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <Link
              href="/hackathon"
              className="text-[#414942] font-semibold hover:text-[#1c1b1b] transition-colors hover:scale-105 duration-300 ease-in-out"
            >
              Hackathons
            </Link>
            <Link
          ...
          <div className="flex items-center space-x-6">
            <Link href={"/profile"} className="hover:scale-105 transition-transform">
              <User className="h-6 w-6 text-[#1c1b1b]" />
            </Link>
            
            <button className="hidden lg:block bg-on-primary-fixed text-surface px-6 py-2.5 rounded-full font-semibold hover:scale-105 transition-all duration-300 active:scale-95">
              Host Opportunity
            </button>
          </div>
